...
export class AsesorInmuebleController {
  ...
  async find(
    ...
    return this.asesorRepository.supervisa(id).find(filter);
  }
  ...
  async create(
    ...
    return this.asesorRepository.supervisa(id).create(inmueble);
  }
  ...
  async patch(
    ...
    return this.asesorRepository.supervisa(id).patch(inmueble, where);
  }
  ...
  async delete(
    ...
    return this.asesorRepository.supervisa(id).delete(where);
  }
}
